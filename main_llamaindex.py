...
def load_docs():
    ...
    for folder in os.listdir(r"C:\Users\Catalect\PycharmProjects\tadawulchat\data"):
        ...
        pdf_reader = PyPDF2.PdfReader(os.path.join(r"C:\Users\Catalect\PycharmProjects\tadawulchat\data", folder))
        text = ""
...
filename = r"C:\Users\Catalect\PycharmProjects\tadawulchat\data"
