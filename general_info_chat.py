...
def get_vector_index():
    ...
    # index.storage_context.persist("index/general_info_chat")
    index = load_index_from_storage(StorageContext.from_defaults(persist_dir="index/general_info_chat"))
...
def get_re_ranker():
    ...
    cohere_rerank = CohereRerank(api_key=os.getenv("COHERE_API_KEY"), top_n=5)
...
def get_response(question):
    ...
    response = query_engine.query(question + "\n Present the information is a nice simple markdown. ")
    return response
